...
<head>
    ...
    <meta name="title" content="VHD WebSites">
<meta name="description" content="Queremos ajudar micro e pequenas empresas a ter sua página na web, para atingir seu público alvo!!">

<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="https:// www.vhdwebsites.com.br">
<meta property="og:title" content="VHD WebSites">
<meta property="og:description" content="Queremos ajudar micro e pequenas empresas a ter sua página na web, para atingir seu público alvo!!">
<meta property="og:image" content="https://metatags.io/assets/meta-tags-16a33a6a8531e519cc0936fbba0ad904e52d35f34a46c97a2c9f6f7dd7d336f2.png">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="https:// www.vhdwebsites.com.br">
<meta property="twitter:title" content="VHD WebSites">
<meta property="twitter:description" content="Queremos ajudar micro e pequenas empresas a ter sua página na web, para atingir seu público alvo!!">
<meta property="twitter:image" content="https://metatags.io/assets/meta-tags-16a33a6a8531e519cc0936fbba0ad904e52d35f34a46c97a2c9f6f7dd7d336f2.png">

    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css" integrity="sha384-TX8t27EcRE3e/ihU7zmQxVncDAy5uIKz4rEkgIXeMed4M0jlfIDPvg6uqKI2xXr2" crossorigin="anonymous">
    <link rel="stylesheet" href="./CSS/style.css">
   <script data-ad-client="ca-pub-8306877478007609" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-HXYMMGNFHH"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-HXYMMGNFHH');
    </script>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-info ">
  ...
  <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample05">
    <ul class="navbar-nav ">
      ...
      <li class="nav-item active menu">
        <a class="nav-link" href="#planos" id="animar">Planos </a>
      </li>
      <li class="nav-item active menu">
        <a class="nav-link" href="eccomerce.php">E-Commerce</a>
      </li> 
      <li class="nav-item active menu">
        <a class="nav-link" href="#sites" id="animar2">Sites </a>
      </li> 
      <li class="nav-item active menu">
        <a class="nav-link" href="#fale">Fale Conosco</a>
      </li>
      <li class="nav-item active menu">
        <a class="nav-link" href="login.php">Area do cliente</a>
      </li>   
    </ul>
...
<main role="main">
  ...
  <section class="jumbotron text-center">
    <div class="container">
      <h1>Compre seu site personalizado!</h1>
      <p class="lead text-muted">Faça já o seu orçamento com a nossa equipe e construa a porta de entrada da sua empresa ou marca na WEB!</p>
      <p class="lead text-muted">Contamos com 3 planos que cabem no seu bolso, o <a href="#planos"> Basico, Intermediario e Avançado</a>. Faça já o seu orçamento clicando no botão abaixo!</p>
      <p>
        <a href="#fale" class="btn btn-primary my-2">Fale Conosco</a>
      </p>
      <img src="./capa/homepage-e1594239411391.png" class="img-fluid capa" alt="Responsive image">
    </div>
  </section>
<br>
  <div class="album py-5 bg-light" id="planos">
    <div class="container " >
        <h1 class="titulo text-center" id="titulo">Planos</h1>
        <p class="lead text-muted titulo text-center" id="titulo2">Veja nossos planos para escolher o que mais se encaixa com o seu projeto. Se você deseja algo mais customizado, entre em contato no <a href="#fale" class="btn btn-primary my-2">Fale Conosco</a> e nos informe!</p>
        <br>

      <div class="row fotos" id="fotos">
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            <img src="./icon/basico.png" class="img_prod">
            <div class="card-body">
              <p class="lead text-primary text-center">Neste plano você conta com:</p>
              <ul class="list-group text-center">

                <li class="list-group-item list-group-item-action list-group-item-info"><img src="./icon/web.png"> Site Basico*</li>
                <li class="list-group-item list-group-item-action list-group-item-info"><img src="./icon/ssd-drive.png"> 2Gb de Armazenamento</li>
                <li class="list-group-item list-group-item-action list-group-item-info"><img src="./icon/mail.png"> 1 Conta de E-Mail</li>
                <li class="list-group-item list-group-item-action list-group-item-info"><img src="./icon/refresh.png"> Atualizações Quinzenais</li>
                <li class="list-group-item list-group-item-action list-group-item-info"><img src="./icon/suporte.png"> Suporte 24/7</li>
                <p class="text-black-50 text-center">*Site Basico Single Page</p>
                <div class="text-center">
              <span class="text-info  rs" style="font-size:24px;" >**R$</span>
              <span class="text-info  money" style="font-size: 2.6em;">15,00</span>
              <span class="text-info ">/Mês</span>

              </div>
              </ul>
            </div>
          </div>
          <a href="#fale" class="btn btn-primary btn_alin">Contratar</a>
          <br>
        </div>
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
          <img src="./icon/INTERMEDIARIO.png" class="img_prod">
            <div class="card-body">
            <p class="lead text-primary text-center">Neste plano você conta com:</p>
              <ul class="list-group text-center">
                <li class="list-group-item bg_item"><img src="./icon/web.png"> Site Personalizado*</li>
                <li class="list-group-item  bg_item"><img src="./icon/ssd-drive.png"> 10Gb de Armazenamento</li>
                <li class="list-group-item  bg_item"><img src="./icon/mail.png"> 10 Contas de E-Mail</li>
                <li class="list-group-item  bg_item"><img src="./icon/refresh.png"> Atualizações Semanais</li>
                <li class="list-group-item  bg_item"><img src="./icon/suporte.png"> Suporte 24/7</li>
              </ul>
              <p class="text-black-50 text-center">*Site com tema da escolha do cliente</p>
              <div class="text-center">
              <span class="text-info  rs" style="font-size:24px;" >**R$</span>
              <span class="text-info  money" style="font-size: 2.6em;">35,00</span>
              <span class="text-info ">/Mês</span>
        ...
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            <img src="./icon/AVANCADO.png" class="img_prod">
            <div class="card-body">
            <p class="lead text-primary text-center">Neste plano você conta com:</p>
            <ul class="list-group text-center">
                <li class="list-group-item list-group-item-action list-group-item-danger"><img src="./icon/web.png"> Site Personalizado*</li>
                <li class="list-group-item list-group-item-action list-group-item-danger"><img src="./icon/ssd-drive.png"> 20Gb de Armazenamento</li>
                <li class="list-group-item list-group-item-action list-group-item-danger"><img src="./icon/mail.png"> Contas de E-Mail Ilimitadas</li>
                <li class="list-group-item list-group-item-action list-group-item-danger"><img src="./icon/refresh.png"> Atualizações Diarias</li>
                <li class="list-group-item list-group-item-action list-group-item-danger"><img src="./icon/suporte.png"> Suporte 24/7</li>
              </ul>
              
              <p class="text-black-50 text-center">*Site com tema da escolha do cliente</p>
              <div class="text-center">
              <span class="text-info  rs" style="font-size:24px;" >**R$</span>
              <span class="text-info  money" style="font-size: 2.6em;">70,00</span>
              <span class="text-info ">/Mês</span>
  ...
  <p class="text-black-50 text-center">** Valor de montagem do WebSite a parte. Para mais informações solicite um orçamento!</p>

</main>

<section class="jumbotron text-center " id="sites">
    <div class="container titulo2" id="titulo3" >
    <h1 class="titulo text-center">Sites</h1>
    <p class="lead text-muted">Veja alguns exemplos de como pode ser o seu site!</p>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
          <a href="./icon/screenshot.png"><img src="./icon/screenshot.png" alt="" class="bd-placeholder-img card-img-top" width="100%" height="225" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"></a>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
          <a href="./icon/template08.jpg"><img src="./icon/template08.jpg" alt="" class="bd-placeholder-img card-img-top" width="100%" height="225" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"></a>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
          
          <a href="./icon/screenshot.jpg"><img src="./icon/screenshot.jpg" alt="" class="bd-placeholder-img card-img-top" width="100%" height="225" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"></a>
        ...
        <div class="col-md-4">
          ...
          <a href="./icon/theme.jpg"><img src="./icon/theme.jpg" alt="" class="bd-placeholder-img card-img-top" width="100%" height="225" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"></a>
        ...
        <div class="col-md-4">
          ...
          <a href="./icon/business.jpg"><img src="./icon/business.jpg" alt="" class="bd-placeholder-img card-img-top" width="100%" height="225" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"></a>
        ...
        <div class="col-md-4">
          ...
          <a href="./icon/popular.jpg"><img src="./icon/popular.jpg" alt="" class="bd-placeholder-img card-img-top" width="100%" height="225" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"></a>
    ...
    <section class="bg-light" id="fale">
  ...
  <div class="row">
    <div class="col-8"><form method="post" action="envia.php" enctype="multipart/form-data">
          <div class="form-row ">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              <label for="exampleFormControlFile1">Adicione o tema que desejar</label>
              <input type="file" class="form-control-file" name="img" id="img" accept="image/*">
            </div>
          </div>
  
          <div class="form-group">
            <label for="soli">Solicitação</label>
            <textarea class="form-control area" name="soli" rows="3" required></textarea>
          </div>
          <button type="submit" class="btn btn-primary" name="submit">Enviar</button>
</form></div>
    <div class="col"><iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fvhdwebsites&tabs=timeline&width=340&height=500&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="340" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe></div>
...
<script>
variavel = document.getElementById("animar");
variavel1 = document.getElementById("animar2");
let el = document.getElementById("titulo");
let el1 = document.getElementById("titulo2");
let el2 = document.getElementById("fotos");
let el3 = document.getElementById("titulo3");

variavel.onclick = function efeito() {
   el.classList.remove("titulo");
   el1.classList.remove("titulo");
   el2.classList.remove("fotos");
   el3.classList.remove("titulo2");
   
   setTimeout(function() {
    el.classList.add("titulo");
    el1.classList.add("titulo");
    el2.classList.add("fotos");
    el3.classList.add("titulo2");
   }, 10);
}

variavel1.onclick = function efeito() {
